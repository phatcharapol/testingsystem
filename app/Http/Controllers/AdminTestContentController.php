...
class AdminTestContentController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        // $subjects=TestSubject::pluck('name','id') ;
        // return view('admin.test.createcontent',compact('subjects')) ;
    }
    ...
    public function show($id)
    {
        ...
        //             ->get();
         ...
         return view('admin.test.indexquestion',compact('testsubject','testcontent','questions'));
    ...
    public function edit($id)
    {
        ...
        $testcontent=TestContent::findOrFail($id) ;
        $testsubject=TestSubject::findOrFail($testcontent->subject_id) ;
        return view('admin.test.editcontent',compact('testsubject','testcontent')) ;
    }
