				...
				<div class="row">
					<div class="col-sm-6">
		 	 		...
		 	 		<div class="col-sm-6" style="padding-top: 10px;">
						<form class="form-inline" method="post" action="{{route('admin.subject.store')}}">
						     @csrf
        ...
        <tbody>
           @foreach($testsubjects->all() as $testsubject)
			 ...
			 <tr>
			 	...
			 	<td><a href="{{route('admin.subject.show',$testsubject->id)}}" class="btn btn-success">Detail</a></td>
			 	<td><a href="{{route('admin.subject.edit',$testsubject->id)}}" class="btn btn-info" >Edit</a></td>
			 	<td> 			
			 		<form method="post" action="{{route('admin.subject.destroy',$testsubject->id)}}">
			 			@csrf
