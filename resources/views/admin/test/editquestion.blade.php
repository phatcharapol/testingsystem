			...
			<td>
				<div align="left" style="float:left;display: inline;">
	 	 		...
	 	 		<div align="right" style="padding-top: 15px">
	 	 			...
	 	 			{{-- <a class="btn btn-info" href="{{route('admin.question.update')}}" role="button" >Update Question</a> --}}
	 	 			{{-- <a class="btn btn-danger" href="{{route('admin.content.create')}}" role="button" onclick ="confirmdelete()" >Delete Question</a> --}}
	 	 		</div>
...
{{-- 	{{dd($testquestiondetails->all())}} --}}
	  <table class="table" width="100%">
				<form method="post" action="{{route('admin.question.update',$testquestion->id)}}">
				@csrf
